...
- [x] Sorting: bubble, merge, quick sort (animated bars, play/pause/speed)
- [x] Trees: in/pre/post-order DFS, BFS, search, insert
- [x] Hash Tables: insert, lookup, frequency count, two-sum
